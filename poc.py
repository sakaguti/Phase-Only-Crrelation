...
def poc(f, g, fitting_shape = (9, 9)):
    ...
    max_peak = r[int(peak[0]), int(peak[1])]

    mf = numpy.floor(list(map(lambda x: x / 2.0, fitting_shape)))
...
if __name__ == '__main__':
    ...
    img2 = cv2.imread("lena_x59_y16.jpg", 0)
    #
    # (32, 18)
    #img1 = cv2.imread("20150727015502.png", 0)
    #img2 = cv2.imread("20150727015534.png", 0)

    r,shiftY,shiftX=poc(img1, img2)
    print('R=',r,'ShiftX=',shiftX,'shiftY=',shiftY)
